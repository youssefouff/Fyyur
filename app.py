...
def venues():
  ...
  #to prevent duplications in venues
  locations = set()
...
def show_venue(venue_id):
  ...
  #displaying shows for the selected venue
  for show in shows:
    data = {
    ...
    #check the date of each show to specify whether it's upcoming or already performed
